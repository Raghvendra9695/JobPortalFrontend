...
const Home = () => {
  // FINAL LIST: Capgemini, Wipro, Netflix, TCS, HCL
  const companies = [
    { 
      name: "Capgemini", 
      logo: "https://imgs.search.brave.com/cLK9fAvHL3UKKhW2v9EiwjiE20fkDlsgYK3qDKQomK0/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9sb2dv/dHlwLnVzL2ZpbGUv/Y2FwZ2VtaW5pLnN2/Zw" 
    },
    { 
      name: "Wipro", 
      logo: "https://imgs.search.brave.com/VlyHfK02jTFzlUYghEPRwZrlhDcLuqsJZtKQS20Kl38/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9hc3Nl/dHMtbmV0c3RvcmFn/ZS5ncm93dy5pbi9z/dG9jay1hc3NldHMv/bG9nb3MyL1dJUFJP/LndlYnA" 
    },
    { 
      name: "Netflix", 
      logo: "https://cdn.brandfetch.io/netflix.com/w/200/h/200?c=1idgmB7XJ8" 
    },
    { 
      name: "TCS", 
      logo: "https://imgs.search.brave.com/BgUuOpgae11C1rMadPusA4Q485XPk6zOZ8zEoodBtNE/rs:fit:0:180:1:0/g:ce/aHR0cHM6Ly9zdGF0/aWMud2lraWEubm9j/b29raWUubmV0L2xv/Z29wZWRpYS9pbWFn/ZXMvYS9hOS9UQ1Nf/NTBfVGF0YV9Db25z/dWx0YW5jeV9TZXJ2/aWNlcy5wbmcvcmV2/aXNpb24vbGF0ZXN0/L3NjYWxlLXRvLXdp/ZHRoLWRvd24vMzAw/P2NiPTIwMjEwNjA3/MDc0MjE4" 
    },
    { 
      name: "HCL Tech", 
      logo: "https://imgs.search.brave.com/UXdu-jDUgt1iYA7a1SHq87deeA2QmKA2-fjpxsaoGZk/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly93d3cu/bG9nby53aW5lL2Ev/bG9nby9IQ0xfVGVj/aG5vbG9naWVzL0hD/TF9UZWNobm9sb2dp/ZXMtTG9nby53aW5l/LnN2Zw" 
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 1. Hero Section (Light Gradient wala) */}
      <Hero /> 

      {/* 2. Top Companies Logos - Light Background */}
      ...
      {/* 4. Call to Action - Soft Blue Gradient */}
